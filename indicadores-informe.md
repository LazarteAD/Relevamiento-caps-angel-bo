...
| E | Edad |
| F | Sexo |
| G | Presión Arterial (texto, ej. "150/95") |
| H | Resultado (Normal/Alterada) |
...
```
=CONTAR.SI(Hoja1!H2:H;"<>")
```

**Casos con TA alterada**
```
=CONTAR.SI(Hoja1!H2:H;"Alterada")
```

**Tasa de hallazgos con TA elevada (%)**
```
=CONTAR.SI(Hoja1!H2:H;"Alterada") / CONTAR.SI(Hoja1!H2:H;"<>") * 100
```

**Casos con antecedentes familiares**
```
=CONTAR.SI(Hoja1!I2:I;"Sí")
```
...
```
=CONTAR.SI(Hoja1!J2:J;"Sí") / CONTAR.SI(Hoja1!H2:H;"Alterada") * 100
```
...
- **Normal vs. Alterada**: gráfico de torta sobre la columna H (Resultado).
- **Casos alterados por edad**: gráfico de barras cruzando columna E (Edad, agrupada en rangos) con columna H.
- **Antecedentes familiares vs. TA alterada**: gráfico de barras cruzando columna I con columna H.
...
- **Derivación vs. no derivación** entre los casos alterados: gráfico de torta sobre columna J filtrando solo filas donde H = "Alterada".
