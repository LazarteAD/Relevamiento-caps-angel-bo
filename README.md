...
Fecha, relevador, barrio/zona, dirección, tipo de relevamiento, observaciones, ubicación GPS (opcional).
Si necesitás otros campos, decime cuáles y te actualizo el formulario y el script.
